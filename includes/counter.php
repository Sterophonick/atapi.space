...
function hitCounter() {
    ...
    $bots = ['bot', 'crawl', 'spider', 'slurp', 'curl', 'python', 'convera', "facebookexternalhit", "meta-", 'mastodon', 'akkoma', 'misskey', 'sindresorhus', 'discord', 'pleroma', 'rss', 'sharkey', 'wget', "Chrome-Lighthouse" ];
