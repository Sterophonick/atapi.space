...
// Call the LastFM REST API to get the stats of my LastFM acc because I can't trust many other services to do exactly what I want.
...
function getLastFmData() {
    ...
    $lastFmDataArray = array("Failed to get LastFM data.", "", "", "/assets/img/home/lastfmicons/empty.png", "https://www.last.fm/user/Sterophonick");
    ...
    $trackUrl = $lastFmDecode["recenttracks"]["track"][0]["url"];
    if(!empty($trackUrl)) $lastFmDataArray[4] = $trackUrl;
