...
- United States Democratic Party shows no effort to combat fascism;<br/>Leopards Eating People's Faces party has a delicious meal.<br/>
- McDonald's worker who gave the FBI a tip on Luigi Mangione unable to recieve $50,000 USD reward.<br/>
- Judge (presumably paid-off) blocked The Onion's acquisition of InfoWars.<br/>
- Sony spends $200 million USD on production of Overwatch clone named <i>Concord</i>, game dies immediately after launch and is pulled from shelves and stores.<br/>
- Former Intel CEO Pat Gelsinger starts <a href="https://xcancel.com/PGelsinger/status/1820129317122080977">praying live on Twitter</a>;<br/> retires months later and Moore's Law kicks in leading to Intel's number of CEOs doubling every two years.<br/>
- The PlayStation 5 Pro.<br/>
...
Honorable mentions:<br/>
- Internet Archive gets taken out for an entire month, user data leaked. Hacker trolls adminsitrators that entire month. Salutes to you, mysterious Keyboard Cowboy, for forcing them to beef up their security in a time of rising fascism.<br/>
- The Heritage Foundation, one of the several purveyors of christofascism in the United States, gets hacked by gay furries. Mike Howell is asked about his opinions on vore.<br/>
...
- Pokémon Black & White 1+2 SVN repositories<br/>
- Pokémon HeartGold & SoulSilver SVN respository<br/>
- Pokémon Platinum SVN repository<br/>
- Pokémon Ultra Sun & Ultra Moon SVN repositories<br/>
- Artwork source files<br/>
- Detective Pikachu film documentation<br/>
- Incomplete source code to Pokémon X & Y<br/>
- Design documents for games and anime<br/>
- Pokémon Omega Ruby / Alpha Sapphire interal dev wiki<br/>
- Various builds of games and tools<br/>
- PoC build of Pokémon Legends: Arceus for Switch and Windows<br/>
- Pokémon: Let's Go Pikachu! / Eevee! git repos, no assets<br/>
- many, many more things<br/>
<img width="384px" src="/assets/img/blog/2024inreview/pokemon.jpg"><br/><br/>

Honorable mentions:<br/>
- Rayman 2 Beta Version for Windows<br/>
- Builds of Call of Duty: Future Warfare (18 Dec 2011 - 8 Jan 2012)<br/>
- Half-Life 1 animation source files<br/>
- MS-DOS 4.00 Source code<br/>
- DuckTales Remastered source code (part of the WayForward Purchase)<br/>
- AMD 4800S main firmware ROM and efuses<br/>
- TimeSplitters 4 Internal pitch demo<br/>
- Portal: Still Alive debug XEX+PDB for Xbox 360<br/>
- Many, many builds of Windows<br/>
...
Honorable mentions:<br/>
- CVE-2024-3400: Palo Alto command injection<br/>
- CVE-2024-30051: Privilege escalation in Windows DWM<br/>
- CVE-2024-38021: Remote Code Execution in Microsoft Outlook<br/>
- CVE-2024-6387: Remote Code Execution in OpenSSH<br/>
- CVE-2024-9680: Use-After-Free in Mozilla Firefox<br/>
- CVE-2024-7589: Heap Overflow in VMware vCenter<br/>
- CVE-2024-20329: OS Command Injection is Cisco Adaptive Security Appliances<br/>
...
Honorable Mentions:<br/>
- The Joke-Explainer 7000's Highest Quality Rips: Sunrise / Sunset<br/>
- Scrappy412 - Deep Blue but it's Elevator Jazz<br/>
- nanka - Roots of Ruin (LSDj Cover)<br/>
- Shoji Meguro - Iwatodai Dorm (Persona 3)<br/>
- Masato Nakamura - Chemical Plant Act 2 (Sonic Generations)<br/>
- kfaraday - On the Road<br/>
- TristEndo - Tupac eats pizza and rolls blunts<br/>
- Nightmargin - On Little Cat Feet<br/>
- Keitarou Hanada - Bring it On (Like a Dragon Gaiden)<br/>
- Jiko Music - GET INVOLVED (Beta Mix)<br/>
- ludosmo - ねえ (Dr. Wily Version)<br/>
- Linkin Park - Don't Stay<br/>
- Hidenori Shoji - Renewed Unrest (Yakuza Kiwami)<br/>
- VA - Body That (MADWORLD)<br/>
- The Glass Pyramids - My Heart Feels No Pain (Hi-Fi RUSH)<br/>
- layo - ramen beat<br/>
- layo - hip hop up<br/>
- Avith Ortega - Revival of Pacificity<br/>
- Akira Yamaoka - Prisonic Fairytale<br/>
...
Honorable Mentions (not all the games I played):<br/>
- Prey (2006 & 2017)<br/>
...
- Judgment<br/>
- Metal Gear Solid<br/>
- Sly Cooper and the Thevius Raccoonus<br/>
- God of War "Dad of Boy"<br/>
- Silent Hill<br/>
- Piglet's Big Game<br/>
- Metal Gear Rising: Revengeance<br/>
- Bomb Rush Cyberfunk<br/>
- Sam & Max: The Devil's Playhouse Remastered<br/>
- Devil May Cry<br/>
- Bayonetta 2<br/>
- Peter Jackson's King Kong<br/>
- Yakuza Kiwami 1+2<br/>
...
<img width="768px" src="/assets/img/blog/2024inreview/haze.png"><br/><br/>

Honorable mentions:<br/>
- Nintendo Co, Ltd. v. Pocketpair, Inc.<br/>
- Nintendo of America Inc. v. Keighin (this one's a real banger)<br/>
</p>
